  ...
  const handleCheckout = () => {
    ...
    return(
      ...
      <View>
        ...
        <TouchableOpacity onPress={handleCheckout} style={{backgroundColor:'#1C2536', paddingVertical:15,marginHorizontal:20, borderRadius:50,marginTop:10, marginBottom:30}}><Text style={{textAlign:'center', color:'white'}}>Login</Text></TouchableOpacity>
      </View>
      ...
      <TouchableOpacity onPress={handleRegister} style={{borderWidth:1, borderRadius:50, marginHorizontal:20, marginTop:30, paddingVertical:10, paddingHorizontal:20}}><Text style={{textAlign:'center'}}>Register</Text></TouchableOpacity>
    </SafeAreaView>
    )
}
