...
const SuccessPage = ({navigation}) =>{
    ...
    return(
      ...
      <View style={{marginHorizontal:10, paddingHorizontal:15, paddingVertical:10}}>
        ...
        <TouchableOpacity style={{borderWidth:1, marginTop:10, marginBottom:30, borderRadius:50, paddingVertical:10,marginHorizontal:100}}><Text style={{textAlign:'center'}}>Homepage</Text></TouchableOpacity>
      </View>
