...
const RegisterPage = ({navigation}) => {
    return(
      ...
      <Text style={{marginHorizontal:20}} >Username</Text>
        ...
        <TextInput placeholder="Your Password" style={{marginHorizontal:20, marginTop:10, marginBottom:20, borderWidth:1, borderRadius:50, paddingVertical:10, paddingHorizontal:20}}/>
        <TouchableOpacity style={{backgroundColor:'#1C2536', paddingVertical:15,marginHorizontal:20, borderRadius:50,marginTop:10, marginBottom:30}}><Text style={{textAlign:'center', color:'white'}}>Register</Text></TouchableOpacity>
      </View>
      ...
      <TouchableOpacity style={{borderWidth:1, borderRadius:50, marginHorizontal:20, marginTop:30, paddingVertical:10, paddingHorizontal:20}}><Text style={{textAlign:'center'}}>Login</Text></TouchableOpacity>
    </SafeAreaView>
    )
}
